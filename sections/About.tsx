...
const About = () => {
  return (
    <section className="section-about" id="about">
      <h2 className="heading heading-2 about__heading">About the museum</h2>
      <div className="what-we-do">
        ...
        <div className="about-content mb-lg mt-lg ">
          ...
          <p className="about-content__text text-lg">{about[0].desc}</p>
        </div>
      </div>
      <div className="vision-and-mission">
        <div className="about-content mb-lg-x">
          ...
          <p className="about-content__text text-lg">{about[1].desc}</p>
        </div>
        <div className="about__image">
          <Image
            width={450}
